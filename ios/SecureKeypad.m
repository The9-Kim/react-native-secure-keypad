...
@interface SecureKeypad : RCTViewManager
@end
...
RCT_REMAP_METHOD(show,
                 showWithUrl:(nonnull NSString*) url maxLength:(Integer) labelText:(nonnull NSString*) labelText isNeedNewHash(Bool)isNeedNewHash
